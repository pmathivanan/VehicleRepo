package org.mathivanan.vehicle.database;
...
public class VehicleDatabase {
	...
	static {
		...
		try {
			...
			connection=DriverManager.getConnection("jdbc:h2:mem:testdb;LOCK_MODE=0;INIT=runscript from 'C:/Sangeetha/workspaces/Sts/VehicleRepo/src/main/resources/init.sql'", "sa", "");
